...
- **email**: Email portal (akan replace "titikjabar33@gmail.com")
- **socialHandle**: Handle social media (akan replace "titikjabar")
- **colors**: Tema warna
...
| `titikjabar` | `siteName` (tanpa spaces) |
| `titikjabar` | `socialHandle` |
| `titikjabar33@gmail.com` | `email` |
